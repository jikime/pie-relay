...
// Browsers type timers as numbers while Node exposes Timeout.unref(). Keep the
// transport portable across the desktop and extracted mobile TS configs.
