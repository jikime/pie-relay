export const MOBILE_E2EE_LEGACY_FIXTURE = {
  ...
  // Deterministic public test vector derived from the fixed byte arrays above.
  sharedKeyHex: '18a99320f3488fa18a04239715d8ee738065e65c3d4b2898522d6c3d4ead588c', // gitleaks:allow
