...
export default function RootLayout() {
  ...
  useEffect(() => {
    ...
    // Why: route `pierelay://pair?...` deep links to the confirm screen so
  ...
  useEffect(() => {
    function handleUrl(url: string) {
      ...
      if (code) {
        ...
        // `pierelay://pair` route underneath this screen; replacing keeps cancel
      ...
      <View style={styles.root} onLayout={onNavigatorLayout}>
        ...
        >
          <Stack.Screen
            ...
            options={{
              headerShown: false,
              headerTitle: () => <PieRelayLogo size={24} />
            }}
          />
