  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + spacing.sm }]}>
      ...
      <View style={styles.brand}>
        <PieRelayLogo size={36} />
        <Text style={styles.brandName}>Pie Relay</Text>
        <Text style={styles.brandSub}>Secure remote terminal by PieLab</Text>
      </View>

      <View style={styles.section}>
        <Pressable
          style={({ pressed }) => [styles.row, pressed && styles.rowPressed]}
          onPress={() => void Linking.openURL('https://cookai.dev')}
        >
          <Globe size={16} color={colors.textSecondary} />
          <Text style={styles.rowValue}>cookai.dev</Text>
        </Pressable>
        ...
        >
          <GithubIcon />
          <Text style={styles.rowValue}>PieLab</Text>
        </Pressable>
        <View style={styles.separator} />
        <Pressable
          style={({ pressed }) => [styles.row, pressed && styles.rowPressed]}
        ...
        >
          <XIcon />
          <Text style={styles.rowValue}>Pie Relay</Text>
        </Pressable>
      </View>
