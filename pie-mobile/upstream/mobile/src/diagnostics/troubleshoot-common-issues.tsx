...
export const troubleshootCommonIssues: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow Pie Relay.',
      'Windows: Defender Firewall → Allow app — enable Pie Relay for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'Pie Relay must be open on your desktop to accept connections.',
      'Try restarting Pie Relay — the companion server starts on launch.',
